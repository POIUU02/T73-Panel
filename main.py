...
async def startup():
    ...
    # Ensure a ready-to-use "Default" subscription link exists as soon as
    # the panel boots, so https://<domain>/sub/Default works immediately
    # without the user having to create one manually.
